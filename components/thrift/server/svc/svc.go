...
type ServiceManager interface {
  // Parameters:
  //  - Svc
  Add(ctx context.Context, svc *Service) (err error)
  // Parameters:
  //  - Name
  Remove(ctx context.Context, name string) (err error)
  // Parameters:
  //  - Name
  //  - Params
  Start(ctx context.Context, name string, params string) (r string, err error)
  // Parameters:
  //  - Name
  Stop(ctx context.Context, name string) (err error)
  // Parameters:
  //  - Pid
  StopInstance(ctx context.Context, pid string) (err error)
  // Parameters:
  //  - Pid
  GetInstance(ctx context.Context, pid string) (r *Instance, err error)
  // Parameters:
  //  - Name
  GetService(ctx context.Context, name string) (r *Service, err error)
  // Parameters:
  //  - Name
  //  - Key
  //  - Value
  SetView(ctx context.Context, name string, key string, value string) (err error)
  GetAllServices(ctx context.Context) (r map[string]*Service, err error)
  Cwd(ctx context.Context) (r string, err error)
  Quit(ctx context.Context) (err error)
}
...
// Deprecated: Use NewServiceManager instead
...
func NewServiceManagerClient(c thrift.TClient) *ServiceManagerClient {
  return &ServiceManagerClient{
    c: c,
  }
}
...
// Parameters:
//  - Svc
func (p *ServiceManagerClient) Add(ctx context.Context, svc *Service) (err error) {
  var _args5 ServiceManagerAddArgs
  _args5.Svc = svc
  var _result6 ServiceManagerAddResult
  if err = p.c.Call(ctx, "add", &_args5, &_result6); err != nil {
    return
  }
  return nil
}
...
// Parameters:
//  - Name
func (p *ServiceManagerClient) Remove(ctx context.Context, name string) (err error) {
  var _args7 ServiceManagerRemoveArgs
  _args7.Name = name
  var _result8 ServiceManagerRemoveResult
  if err = p.c.Call(ctx, "remove", &_args7, &_result8); err != nil {
    return
  }
  return nil
}
...
//  - Name
//  - Params
func (p *ServiceManagerClient) Start(ctx context.Context, name string, params string) (r string, err error) {
  var _args9 ServiceManagerStartArgs
  _args9.Name = name
  _args9.Params = params
  var _result10 ServiceManagerStartResult
  if err = p.c.Call(ctx, "start", &_args9, &_result10); err != nil {
    return
  }
...
// Parameters:
//  - Name
func (p *ServiceManagerClient) Stop(ctx context.Context, name string) (err error) {
  var _args11 ServiceManagerStopArgs
  _args11.Name = name
  var _result12 ServiceManagerStopResult
  if err = p.c.Call(ctx, "stop", &_args11, &_result12); err != nil {
    return
  }
  return nil
}
...
// Parameters:
//  - Pid
func (p *ServiceManagerClient) StopInstance(ctx context.Context, pid string) (err error) {
  var _args13 ServiceManagerStopInstanceArgs
  _args13.Pid = pid
  var _result14 ServiceManagerStopInstanceResult
  if err = p.c.Call(ctx, "stopInstance", &_args13, &_result14); err != nil {
    return
  }
  return nil
}
...
// Parameters:
//  - Pid
func (p *ServiceManagerClient) GetInstance(ctx context.Context, pid string) (r *Instance, err error) {
  var _args15 ServiceManagerGetInstanceArgs
  _args15.Pid = pid
  var _result16 ServiceManagerGetInstanceResult
  if err = p.c.Call(ctx, "getInstance", &_args15, &_result16); err != nil {
    return
  }
...
// Parameters:
//  - Name
func (p *ServiceManagerClient) GetService(ctx context.Context, name string) (r *Service, err error) {
  var _args17 ServiceManagerGetServiceArgs
  _args17.Name = name
  var _result18 ServiceManagerGetServiceResult
  if err = p.c.Call(ctx, "getService", &_args17, &_result18); err != nil {
    return
  }
...
//  - Key
//  - Value
func (p *ServiceManagerClient) SetView(ctx context.Context, name string, key string, value string) (err error) {
  var _args19 ServiceManagerSetViewArgs
  _args19.Name = name
  _args19.Key = key
  _args19.Value = value
  var _result20 ServiceManagerSetViewResult
  if err = p.c.Call(ctx, "setView", &_args19, &_result20); err != nil {
    return
  }
  return nil
}

func (p *ServiceManagerClient) GetAllServices(ctx context.Context) (r map[string]*Service, err error) {
  var _args21 ServiceManagerGetAllServicesArgs
  var _result22 ServiceManagerGetAllServicesResult
  if err = p.c.Call(ctx, "getAllServices", &_args21, &_result22); err != nil {
    return
  }
  return _result22.GetSuccess(), nil
}

func (p *ServiceManagerClient) Cwd(ctx context.Context) (r string, err error) {
  var _args23 ServiceManagerCwdArgs
  var _result24 ServiceManagerCwdResult
  if err = p.c.Call(ctx, "cwd", &_args23, &_result24); err != nil {
    return
  }
  return _result24.GetSuccess(), nil
}

func (p *ServiceManagerClient) Quit(ctx context.Context) (err error) {
  var _args25 ServiceManagerQuitArgs
  var _result26 ServiceManagerQuitResult
  if err = p.c.Call(ctx, "quit", &_args25, &_result26); err != nil {
    return
  }
  return nil
}
...
func (p *ServiceManagerProcessor) Process(ctx context.Context, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
func (p *serviceManagerProcessorAdd) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  var err2 error
  if err2 = p.handler.Add(ctx, args.Svc); err2 != nil {
...
func (p *serviceManagerProcessorRemove) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  var err2 error
  if err2 = p.handler.Remove(ctx, args.Name); err2 != nil {
...
func (p *serviceManagerProcessorStart) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
var retval string
  var err2 error
  if retval, err2 = p.handler.Start(ctx, args.Name, args.Params); err2 != nil {
...
func (p *serviceManagerProcessorStop) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  var err2 error
  if err2 = p.handler.Stop(ctx, args.Name); err2 != nil {
...
func (p *serviceManagerProcessorStopInstance) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  var err2 error
  if err2 = p.handler.StopInstance(ctx, args.Pid); err2 != nil {
...
func (p *serviceManagerProcessorGetInstance) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
var retval *Instance
  var err2 error
  if retval, err2 = p.handler.GetInstance(ctx, args.Pid); err2 != nil {
...
func (p *serviceManagerProcessorGetService) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
var retval *Service
  var err2 error
  if retval, err2 = p.handler.GetService(ctx, args.Name); err2 != nil {
...
func (p *serviceManagerProcessorSetView) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  var err2 error
  if err2 = p.handler.SetView(ctx, args.Name, args.Key, args.Value); err2 != nil {
...
func (p *serviceManagerProcessorGetAllServices) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
var retval map[string]*Service
  var err2 error
  if retval, err2 = p.handler.GetAllServices(ctx); err2 != nil {
...
func (p *serviceManagerProcessorCwd) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
var retval string
  var err2 error
  if retval, err2 = p.handler.Cwd(ctx); err2 != nil {
...
func (p *serviceManagerProcessorQuit) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  var err2 error
  if err2 = p.handler.Quit(ctx); err2 != nil {
