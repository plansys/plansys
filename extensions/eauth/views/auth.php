	...
	<ul class="auth-services clear">
		...
		foreach ($services as $name => $service) {
			if($service->id == 'google_oauth'){
				...
				$html = '<li class="btn-primary auth-service '.$name.'"><a href="'.$url.'" class="auth-link '.$name.'" style="color:#fff;text-decoration:none;"><img src="'.$icon.'" width="24px" style= "padding-right:5px" />Login with Google</a></li>';
